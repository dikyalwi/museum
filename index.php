  ...
  <div class="main-wrap" data-scroll-container>
      ...
      <section class="header2" data-scroll-section>
        <div class="container-fluid p-0">
          ...
          <div class="sechead" data-scroll data-scroll-speed="4">
            <div class="col-12 text-end ">
              <p class="text-right text-emas">Wiswakarma sutejo prayojanam suddham</p>
      ...
      <section class="desc1" data-scroll-section>
        <div class="container-fluid p-5">
          <div class="sec-desc-1" data-scroll>
            <div class="container-fluid p-0" >
              <div class="img-logo" data-scroll data-scroll-speed="4">
        ...
        <div class="container-fluid p-0">
          ...
          <div class="row">
            <div class="col-lg-4 px-4">
              <div class="row">
                <div class="col-12 mb-5 " data-scroll data-scroll-delay="0.1" data-scroll-speed="3">
                  <img src="assets/img/gmr1.jpg" class="">
                </div>
                <div class="col-12 pt-4 pb-5"  data-scroll data-scroll-delay="0.1" data-scroll-speed="3">
                  <?php if($_SESSION['language'] == 'idn'){?>
            ...
            <div class="col-lg-8 px-4">
              <div class="row">
                ...
                <div class="col-sm-6 py-4 pe-4"  data-scroll data-scroll-delay="0.1" data-scroll-speed="3">
                  <?php if($_SESSION['language'] == 'idn'){?>
                ...
                <div class="col-sm-6 py-4 ps-4"  data-scroll data-scroll-delay="0.1" data-scroll-speed="3">
                  <?php if($_SESSION['language'] == 'idn'){?>
      ...
      <section class="kategori" id="activity" data-scroll-section>
        <div class="container-fluid p-0">
          <div class="sec-banner" style="background: url(assets/img/kat1.jpg) no-repeat  ;">
            <div data-scroll data-scroll-direction="horizontal" data-scroll-speed="8">
              <h1>Explorations</h1>
              <?php if($_SESSION['language'] == 'idn'){?>
      ...
      <section class="lokasi" data-scroll-section>
        <div class="container-fluid p-0">
          <div class="sec-loc">
            <div class="row">
              <div class="col-lg-7 d-flex align-items-center justify-content-center" data-scroll data-scroll-delay="0.10" data-scroll-speed="6">
                <h2>Location</h2>
              </div>
              <div class="col-lg-5 d-flex align-items-center position-relative" data-scroll data-scroll-delay="0.16" data-scroll-speed="6">
